...
(function() {
        ...
        if (document.compatMode && document.compatMode == 'BackCompat') {
            if (document.getElementById("af-form-101764561")) {
                document.getElementById("af-form-101764561").className = 'af-form af-quirksMode';
            }
            if (document.getElementById("af-body-101764561")) {
                document.getElementById("af-body-101764561").className = "af-body inline af-quirksMode";
            }
            if (document.getElementById("af-header-101764561")) {
                document.getElementById("af-header-101764561").className = "af-header af-quirksMode";
            }
            if (document.getElementById("af-footer-101764561")) {
                document.getElementById("af-footer-101764561").className = "af-footer af-quirksMode";
            }
        }
    })();
// ]]></script>
<script type="text/javascript">document.getElementById('redirect_fcff69e753412daf1ab2fbc697331dd6').value = document.location;</script>
</head>
