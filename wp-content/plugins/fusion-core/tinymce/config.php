...
$fusion_shortcodes['button'] = array(
	...
	'params' => array(
		...
		'style' => array(
			...
			'desc' => __('Select the button\'s color. Select custom to use advanced color options below.', 'fusion-core'),
			'options' => array(
				'default' => 'Default',
				'custom' => 'Custom',
				'green' => 'Green',
		...
		'gradtopcolor' => array(
			'type' => 'colorpicker',
			'label' => __('Gradient Top Color', 'fusion-core'),
			'desc' => __('Custom setting. Set the top color of the background gradient.', 'fusion-core')
		),
		'gradbottomcolor' => array(
			'type' => 'colorpicker',
			'label' => __('Gradient Bottom Color', 'fusion-core'),
			'desc' => __('Custom setting. Set the bottom color of the background gradient. Leave empty for solid color', 'fusion-core')
		),
		'gradtopcolorhover' => array(
			'type' => 'colorpicker',
			'label' => __('Gradient Top Color Hover', 'fusion-core'),
			'desc' => __('Custom setting. Set the top hover color of the background gradient', 'fusion-core')
		),
		'gradbottomcolorhover' => array(
			'type' => 'colorpicker',
			'label' => __('Gradient Bottom Color Hover', 'fusion-core'),
			'desc' => __('Custom setting. Set the bottom hover color of the background gradient. Leave empty for solid color', 'fusion-core')
		),
		'border' => array(
			'std' => '1px',
			'type' => 'text',
			'label' => __('Border', 'fusion-core'),
			'desc' => 'Custom setting. In pixels (px), ex: 1px.'
		),
		'bordercolor' => array(
			'type' => 'colorpicker',
			'std' => '',
			'label' => __('Border Color', 'fusion-core'),
			'desc' => 'Custom setting. Leave blank for default'
		),
		'textcolor' => array(
			'type' => 'colorpicker',
			'std' => '',
		...
		'textshadow' => array(
			...
			'desc' => __('Choose to enable/disable the shadows', 'fusion-core'),
			'options' => $choices
		),
		'animation_type' => array(
			'type' => 'select',
	...
	'shortcode' => '[button link="{{url}}" color="{{style}}" size="{{size}}" target="{{target}}" title="{{title}}" gradient_colors="{{gradtopcolor}},{{gradbottomcolor}}" gradient_hover_colors="{{gradtopcolorhover}},{{gradbottomcolorhover}}" border_width="{{border}}" border_color="{{bordercolor}}" text_color="{{textcolor}}" shadow="{{textshadow}}" animation_type="{{animation_type}}" animation_direction="{{animation_direction}}" animation_speed="{{animation_speed}}"]{{content}}[/button]',
	...
	'child_shortcode' => array(
		'params' => array(
			...
			'unitpos' => array(
				'std' => '',
				'type' => 'select',
				'label' => __( 'Counter Box Unit Position', 'fusion-core' ),
				'desc' => __( 'Select the position of the specified unit.', 'fusion-core' ),
				'options' => array(
					'prefix' => 'Left',
					'suffix' => 'Right',
				)					
		...
		'shortcode' => '[counter_box value="{{value}}" unit="{{unit}}" unit_pos="{{unitpos}}"]{{content}}[/counter_box]',
...
$fusion_shortcodes['googlemap'] = array(
	...
	'params' => array(
		...
		'popup' => array(
			...
			'desc' => 'Display or hide tooltip by default when the map first loads',
			'options' => $choices
		),
		'content' => array(
			'std' => '',
	...
	'shortcode' => '[map address="{{content}}" type="{{type}}" width="{{width}}" height="{{height}}" zoom="{{zoom}}" scrollwheel="{{scrollwheel}}" scale="{{scale}}" zoom_pancontrol="{{zoom_pancontrol}}" popup="{{popup}}"][/map]',
...
$fusion_shortcodes['sectionseparator'] = array(
	...
	'params' => array(
		...
		'iconcolor' => array(
			'type' => 'colorpicker',
			'label' => __('Icon Color', 'fusion-core'),
			'desc' => __('Leave blank when bordercolor should be used', 'fusion-core')
		),
		'border' => array(
			'std' => '1px',
			'type' => 'text',
		...
		'backgroundcolor' => array(
			...
			'desc' => 'Set the background color for the triangle candy'
		),
	),
	'shortcode' => '[section_separator divider_candy="{{divider_candy}}" icon="{{icon}}" icon_color="{{iconcolor}}" bordersize="{{border}}" bordercolor="{{bordercolor}}" backgroundcolor="{{backgroundcolor}}"]',
